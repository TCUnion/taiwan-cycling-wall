...
const 區域樣式: Record<Region, string> = {
  '北部': 'bg-region-north/15 text-region-north',
  '中部': 'bg-region-central/15 text-region-central',
  '南部': 'bg-region-south/15 text-region-south',
  '東部': 'bg-region-east/15 text-region-east',
}
